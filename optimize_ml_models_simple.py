#!/usr/bin/env python
"""
Simplified script to fine-tune ML models and optimize ensemble weights for trading strategies.
"""
import os
import numpy as np
import pandas as pd
...
def load_and_prepare_data(symbols, period='3mo'):
    """
...
def main():
    ...
    X_train, X_test, y_train, y_test, historical_data = load_and_prepare_data(symbols, period='3mo')
